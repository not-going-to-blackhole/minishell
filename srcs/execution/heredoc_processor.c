...
/*   Updated: 2024/01/17 13:25:22 by yeeunpar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void process_heredoc_env(t_env_node *env_list, int fd, char *str)
{
	int     start_idx;
	int     end_idx;
	char    *env_value;
...
static void	mini_heredoc(t_env_node *env_list, char *file_name, char *last_str)
{
	int		fd;
	char	*input;
